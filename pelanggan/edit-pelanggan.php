...
$title = "Edit Pelanggan - CAngelline POS";
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?=
                            $main_url ?>pelanggan/data-pelanggan.php">Pelanggan</a></li>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-pen fa-sm" ></i> Edit Pelanggan</h3>
                        ...
                        <div class="col-lg-8 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama"
                                    placeholder="nama pelanggan" autofocus autocomplete="off" 
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="ketr" name="ketr" rows="1"
                                    placeholder="keterangan pelanggan" required><?= $pelanggan['deskripsi'] ?></textarea>
                        </div>
                        </div>
                    </div>
