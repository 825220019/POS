      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="<?= $main_url ?>supplier/add-supplier.php" class="btn btn-primary btn-sm"><i
            ...
            <tbody>
              ...
              foreach ($suppliers as $supplier): ?>
                <tr>
                  ...
                  <td>
                    <a href="edit-supplier.php?id=<?= $supplier['id_supplier']; ?>" class="btn btn-warning btn-sm"><i
